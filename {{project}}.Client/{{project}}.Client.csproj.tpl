<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="CitizenFX.Core.Client" Version="1.0.26803">
    ...
    <PackageReference Include="NFive.SDK.Client" Version="0.1.0.67">
      <PrivateAssets>all</PrivateAssets>
      <ExcludeAssets>runtime</ExcludeAssets>
    </PackageReference>
  ...
  <ItemGroup>
    <Content Include="Overlays\{{project}}Overlay.html" CopyToOutputDirectory="PreserveNewest" />
  </ItemGroup>{{ if shared }}
